...
type Take2<T extends any[]> = ((..._: T) => 0) extends ((a0: infer A0, a1: infer A1, ..._: any[]) => 0) ? [A0, A1] : never
type Take4<T extends any[]> = ((..._: T) => 0) extends ((a0: infer A0, a1: infer A1, a2: infer A2, a3: infer A3, ..._: any[]) => 0) ? [A0, A1, A2, A3] : never
type Take8<T extends any[]> = ((..._: T) => 0) extends ((a0: infer A0, a1: infer A1, a2: infer A2, a3: infer A3, a4: infer A4, a5: infer A5, a6: infer A6, a7: infer A7, ..._: any[]) => 0) ? [A0, A1, A2, A3, A4, A5, A6, A7] : never
type Take1$<T extends any[]> = ((..._: T) => 0) extends ((a0: infer A0, ..._: any[]) => 0) ? [A0?] : never
type Take2$<T extends any[]> = ((..._: T) => 0) extends ((a0: infer A0, a1: infer A1, ..._: any[]) => 0) ? [A0?, A1?] : never
type Take4$<T extends any[]> = ((..._: T) => 0) extends ((a0: infer A0, a1: infer A1, a2: infer A2, a3: infer A3, ..._: any[]) => 0) ? [A0?, A1?, A2?, A3?] : never
type Take8$<T extends any[]> = ((..._: T) => 0) extends ((a0: infer A0, a1: infer A1, a2: infer A2, a3: infer A3, a4: infer A4, a5: infer A5, a6: infer A6, a7: infer A7, ..._: any[]) => 0) ? [A0?, A1?, A2?, A3?, A4?, A5?, A6?, A7?] : never
